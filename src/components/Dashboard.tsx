...
export default function Dashboard({ onNavigate }: DashboardProps) {
  ...
  // Period Switcher helpers
  const currentMonthStr = useMemo(() => moment().format('YYYY-MM'), []);
  const lastMonthStr = useMemo(() => moment().subtract(1, 'month').format('YYYY-MM'), []);

  const isCurrentMonthActive = selectedMonth === currentMonthStr;
  const isLastMonthActive = selectedMonth === lastMonthStr;
  ...
  const handleNextMonth = () => {
    setSelectedMonth(moment(selectedMonth, 'YYYY-MM').add(1, 'month').format('YYYY-MM'));
  };
  ...
  return (
    <div className="dashboard-container animate-fade-in">
      ...
      <div className="dashboard-header animate-fade-in">
        ...
        <div className="period-switcher-container">
          ...
          <div className="month-picker-pill">
            ...
            <div className="month-picker-label-wrap">
              {loading ? (
                ...
                <Calendar size={14} className="month-calendar-icon" />
              )}
              <DatePicker
                id="month-picker"
        ...
        <div className="hero-submetrics-grid">
          ...
          >
            ...
            <div className="submetric-details">
              ...
              <span className="submetric-number text-income">+{formatCurrency(totalIncome)}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="submetric-details">
              ...
              <span className="submetric-number text-expense">-{formatCurrency(totalExpense)}</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="submetric-details">
              ...
              <span className="submetric-number text-sky">
                        ...
                        <div key={item.categoryId} className="category-progress-row">
                          <div className="cat-row-header">
                            ...
                            <div className="cat-amounts">
                              ...
                              <span className="cat-percent-tag">{item.percentage.toFixed(1)}%</span>
                            </div>
                          </div>
